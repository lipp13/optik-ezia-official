...
import { HeroKineticTextBackground } from "@/components/home/HeroKineticTextBackground";
...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative min-h-[94vh] flex items-center justify-center pt-28 pb-16 overflow-hidden bg-ivory"
    >
      {/* Lightweight GPU-accelerated Kinetic 3D Text Background "EZIA OPTICAL" */}
      <HeroKineticTextBackground />

      {/* Background Subtle Editorial Grid Lines */}
      <motion.div
        style={{ y: bgY }}
        className="absolute inset-0 pointer-events-none opacity-[0.03] bg-[linear-gradient(to_right,#171715_1px,transparent_1px),linear-gradient(to_bottom,#171715_1px,transparent_1px)] bg-[size:4rem_4rem]"
      />

      {/* Ambient Warm Blur Orb */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[500px] h-[500px] rounded-full bg-sand/35 blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 items-center">
          ...
          >
            {/* 3D Perspective Card Container with Lightweight Mouse Tilt Physics */}
            <motion.div
              style={{
                rotateX,
                rotateY,
